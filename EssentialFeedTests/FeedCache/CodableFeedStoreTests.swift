...
//  EssentialFeedTests
//
//  Created by Firdavs Bagirov on 02/07/22.
//
        ...
        sut.retrieve { firstResult in
            sut.retrieve { secondResult in
                ...
                case (.empty, .empty):
                    break
                default:
                    XCTFail("Expected retrieving twice form empty cache to deliver same empty result, got \(firstResult) and \(secondResult) instead")
                }
