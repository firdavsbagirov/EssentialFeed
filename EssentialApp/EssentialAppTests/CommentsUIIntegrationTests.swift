...
//  EssentialAppTests
//
//  Created by Firdavs Bagirov on 15/01/23.
//
...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsCompletion_rendersSuccessfullyLoadedComments() {
        ...
        let comment1 = makeComment(message: "another messgae", username: "another username")
        let (sut, loader) = makeSUT()
    ...
    private func assertThat(_ sut: ListViewController, isRendering comments: [ImageComment], file: StaticString = #filePath, line: UInt = #line) {
        XCTAssertEqual(sut.numberOfRenderedComments(), comments.count, "comments coint", file: file, line: line)
